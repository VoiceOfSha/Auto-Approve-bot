            ...
            keyboard = InlineKeyboardMarkup(
                ...
                [
                    ...
                    [
                        ...
                        InlineKeyboardButton("🗯 Channel", url="https://t.me/+qswNBTRWlv9lNjQ1"),

                        InlineKeyboardButton("💬 Support", url="https://t.me/TamilanBotsZ")

                    ],[

                        InlineKeyboardButton("➕ Add me to your Chat ➕", url="https://t.me/AutoAcceptJoinRequest_RoBot?startgroup")
            ...
            keyboar = InlineKeyboardMarkup(
                ...
                [
                    ...
                    [
                        ...
                        InlineKeyboardButton("💁‍♂️ Start me private 💁‍♂️", url="https://t.me/AutoAcceptJoinRequest_RoBot?start=start")
...
async def chk(_, cb : CallbackQuery):
    ...
    try:
        ...
        if cb.message.chat.type == enums.ChatType.PRIVATE:
            ...
            await cb.message.edit("**🦊 Hello {}!\nI'm an auto approve [Admin Join Requests]({}) Bot.\nI can approve users in Groups/Channels.Add me to your chat and promote me to admin with add members permission.\n\n__Powerd By : @TamilanBotsZ__**".format(cb.from_user.mention, "https://t.me/telegram/153"), reply_markup=keyboard, disable_web_page_preview=True)
